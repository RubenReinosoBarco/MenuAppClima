...
import com.example.ruben.menuappclima.fragments.CiudadesFragment
import com.example.ruben.menuappclima.fragments.ClimaFragment
import com.example.ruben.menuappclima.fragments.HomeFragment
...
class MainActivity : ToolbarActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun loadFragmentById(id: Int) {
        ...
        when (id) {
            ...
            R.id.nav_departures -> fragmentTransaction(CiudadesFragment())
            R.id.nav_arrivals -> fragmentTransaction(NuevaCiudad())
        }
    ...
    private fun setUserHaderInformacion() {
        ...
        // Aqui pondremos los datos del request.user
